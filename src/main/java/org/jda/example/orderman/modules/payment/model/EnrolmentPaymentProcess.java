...
import org.jda.example.orderman.modules.payment.model.Payment.PaymentStatus;
...
/**
 * @overview 
 *  Represents a process of requesting a designated bank of a a {@link Order} to perform 
 *  a {@link Payment}.
 *  
...
//    }
   ...
   * 
   * @effects 
   *  retrieve and return the PaymentProfile of <tt>order</tt>
   *  
   */
   ...
   * 
   * @effects 
   *  compute the sum of fees for all {@link Product}s in <tt>modules</tt>,
   *  return this sum
   */
